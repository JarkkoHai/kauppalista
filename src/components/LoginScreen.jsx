...
import { 
  ...
  GoogleAuthProvider,  // ← UUSI
  signInWithPopup       // ← UUSI
} from 'firebase/auth';
import { 
  ShoppingCart, 
  ChevronRight, 
...
const handleGoogleLogin = async () => {
  ...
  try {
    ...
    if (error.code === 'auth/popup-closed-by-user') {
      setError('Kirjautuminen peruutettu.');
    } else {
...
<div className="relative my-6">
  ...
  <div className="relative flex justify-center text-xs font-bold">
    <span className="bg-white px-3 text-slate-400 uppercase tracking-widest">Tai</span>
  </div>
</div>
